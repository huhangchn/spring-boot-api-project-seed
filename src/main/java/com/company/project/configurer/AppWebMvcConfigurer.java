    ...
    public void configureHandlerExceptionResolvers(List<HandlerExceptionResolver> exceptionResolvers) {
        exceptionResolvers.add((request, response, handler, e) -> {
            ...
            if (e instanceof BusinessException) {//业务失败的异常，如“账号或密码错误”
                ...
                result = ResultUtil.error(businessException.getCode(), businessException.getMessage());
            } else if (e instanceof NoHandlerFoundException) {
                result = ResultUtil.error(ResultEnum.NOT_FOUND, request.getRequestURI());
            } else {
                result= ResultUtil.error(ResultEnum.INTERNAL_SERVER_ERROR, request.getRequestURI());
                    String message;
